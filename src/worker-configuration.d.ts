/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: de2e90931221caafeead6320177e26d7)
// Runtime types generated with workerd@1.20251008.0 2025-10-14 nodejs_als
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../.svelte-kit/cloudflare/_worker");
	}
	interface Env {
		fluxia_database: KVNamespace;
		ASSETS: Fetcher;
	}
}
